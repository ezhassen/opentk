...
namespace OpenTK.Compute.OpenCL
{
    ...
    public class CL : CLBase
    {
        ...
        public static extern CLResultCode GetCommandQueueInfo([In] CLCommandQueue commandQueue, [In] CommandQueueInfo paramName,
        ...
        // TODO Add these 2 opencl 3.0 methods
        /*
        [ClVersion(3,0)]
        ...
        */
        ...
        public static extern CLSampler CreateSamplerWithProperties([In] CLContext context, [In] IntPtr samplerProperties, [Out] out CLResultCode resultCode);
        ...
        public static extern CLProgram CreateProgramWithBuiltInKernels([In] CLContext context, [In] uint numberOfDevices,
        ...
        public static extern CLResultCode SetProgramReleaseCallback([In] CLProgram program, [In] IntPtr notificationCallback, [In] IntPtr userData);
        ...
        public static extern CLResultCode SetProgramSpecializationConstant([In] CLProgram program, [In] uint specId,
            [In] UIntPtr specSize, [In] IntPtr specValue);
        ...
        public static extern IntPtr GetExtensionFunctionAddressForPlatform([In] CLPlatform platform, [In] string functionName);
        ...
        public static extern CLResultCode EnqueueWaitForEvents([In] CLCommandQueue commandQueue, [In] uint numberOfEventsInWaitList, [In] CLEvent[] eventList);
